...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // Первый семестр
        student1.addRecord(new Record("Математический анализ", ControlType.EXAM, Grade.EXCELLENT, 1));
        student1.addRecord(new Record("Алгебра", ControlType.EXAM, Grade.EXCELLENT, 1));
        student1.addRecord(new Record("Программирование", ControlType.EXAM, Grade.EXCELLENT, 1));
        student1.addRecord(new Record("История", ControlType.DIFF_CREDIT, Grade.EXCELLENT, 1));

        // Второй семестр
        student1.addRecord(new Record("Математический анализ", ControlType.EXAM, Grade.EXCELLENT, 2));
        student1.addRecord(new Record("Дискретная математика", ControlType.EXAM, Grade.EXCELLENT, 2));
        student1.addRecord(new Record("ООП", ControlType.EXAM, Grade.EXCELLENT, 2));
        student1.addRecord(new Record("Физическая культура", ControlType.CREDIT, Grade.PASS, 2));
        ...
        System.out.println("Средний балл: " + String.format("%.2f", student1.getAverageGrade()));
        System.out.println("Повышенная стипендия: " + student1.canGetIncreasedScholarship());
        ...
        // Первый семестр
        student2.addRecord(new Record("Математический анализ", ControlType.EXAM, Grade.GOOD, 1));
        student2.addRecord(new Record("Алгебра", ControlType.EXAM, Grade.EXCELLENT, 1));
        student2.addRecord(new Record("Программирование", ControlType.EXAM, Grade.GOOD, 1));

        // Второй семестр
        student2.addRecord(new Record("Математический анализ", ControlType.EXAM, Grade.EXCELLENT, 2));
        student2.addRecord(new Record("Дискретная математика", ControlType.EXAM, Grade.EXCELLENT, 2));
        ...
        System.out.println("Средний балл: " + String.format("%.2f", student2.getAverageGrade()));
        ...
        // Первый семестр
        student3.addRecord(new Record("Математический анализ", ControlType.EXAM, Grade.SATISFACTORY, 1));
        student3.addRecord(new Record("Алгебра", ControlType.EXAM, Grade.GOOD, 1));
        student3.addRecord(new Record("Программирование", ControlType.EXAM, Grade.EXCELLENT, 1));

        // Второй семестр
        student3.addRecord(new Record("Математический анализ", ControlType.EXAM, Grade.GOOD, 2));
        student3.addRecord(new Record("Дискретная математика", ControlType.EXAM, Grade.EXCELLENT, 2));
        student3.addRecord(new Record("ООП", ControlType.EXAM, Grade.GOOD, 2));

        System.out.println("Студент: " + student3.getStudentName());
        System.out.println("Средний балл: " + String.format("%.2f", student3.getAverageGrade()));
        ...
        student4.addRecord(new Record("Предмет 4", ControlType.DIFF_CREDIT, Grade.EXCELLENT, 2));
        ...
        System.out.println("Средний балл: " + String.format("%.2f", student4.getAverageGrade()));
        ...
        student5.addRecord(new Record("Задание по математике №1", ControlType.OTHER, Grade.EXCELLENT, 1));
        student5.addRecord(new Record("Задание по математике №2", ControlType.OTHER, Grade.GOOD, 1));
        student5.addRecord(new Record("Контрольная работа", ControlType.OTHER, Grade.EXCELLENT, 1));
        student5.addRecord(new Record("Физика", ControlType.EXAM, Grade.EXCELLENT, 1));
        student5.addRecord(new Record("Коллоквиум по физике", ControlType.OTHER, Grade.GOOD, 1));
        student5.addRecord(new Record("Программирование", ControlType.DIFF_CREDIT, Grade.EXCELLENT, 1));
